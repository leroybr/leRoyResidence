      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 pt-20">
        <div className="bg-white p-8 md:p-12 rounded-sm shadow-xl max-w-md w-full text-center border-t-4 border-leroy-black">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-leroy-black text-white py-3 text-xs font-bold uppercase tracking-widest hover:bg-leroy-gold transition-colors duration-300"
            >
              Ingresar
            </button>
          </form>
          ...
          <button
            onClick={onCancel}
            className="mt-8 text-[10px] font-bold uppercase tracking-widest text-gray-400 hover:text-leroy-black transition-colors"
          >
            Volver al sitio
          </button>
        </div>
    ...
    <div className="pt-28 pb-20 min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            onClick={onCancel}
            className="text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-leroy-black"
          >
            Cerrar Sesión
          </button>
        </div>
        ...
        <div className="flex space-x-1 bg-gray-200 p-1 rounded-lg w-fit mb-8">
          <button
            ...
            className={`px-6 py-2 text-xs font-bold uppercase tracking-widest rounded-md transition-all ${
              activeTab === 'manage' ? 'bg-white text-leroy-black shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Inventario
          </button>
          <button
            ...
            className={`px-6 py-2 text-xs font-bold uppercase tracking-widest rounded-md transition-all ${
              activeTab === 'new' ? 'bg-white text-leroy-black shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Crear Propiedad
          </button>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <img
                            src={prop.imageUrl}
                            alt=""
                            className="w-12 h-12 object-cover rounded-sm bg-gray-200"
                          />
                          <div>
                            <p className="font-serif text-sm text-leroy-black font-semibold truncate max-w-[200px]">
                              {prop.title}
                            </p>
                      ...
                      <td className="p-4 text-center">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide ${
                            prop.status === 'paused' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
                          }`}
                        >
                      ...
                      <td className="p-4 text-right">
                        ...
                        {onDeleteProperty && (
                          <button
                            ...
                            className="ml-2 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded border border-red-600 text-red-600 hover:bg-red-50"
                          >
                            Eliminar
                          </button>
                        )}
          ...
          <form onSubmit={handleSubmit} className="space-y-8 animate-in fade-in duration-300">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <div className="flex justify-between items-center border-b pb-2 mb-6">
                ...
                {/* ... Aquí siguen todos los campos del formulario tal cual los tenías ... */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full border-gray-200 bg-gray-50 p-3 rounded text-sm focus:border-leroy-gold focus:ring-0"
                      placeholder="Ej: Espectacular Casa en El Venado"
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full border-gray-200 bg-gray-50 p-3 rounded text-sm focus:border-leroy-gold focus:ring-0"
                      placeholder="Ej: Propiedad heredada poco común en las fincas..."
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 col-span-2 md:col-span-1">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border-gray-200 bg-gray-50 p-3 rounded text-sm"
                      />
                    </div>
                    <div>
