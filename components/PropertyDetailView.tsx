...
  property: Property;
  onNavigate: (view: string, category?: string) => void; // <--- CORREGIDO: Ahora usa onNavigate
}
...
const PropertyDetailView: React.FC<PropertyDetailViewProps> = ({ property, onNavigate }) => { // <--- CORREGIDO: Desestructuración con onNavigate
...
        <button 
          onClick={() => onNavigate('home')} // <--- CORREGIDO: Usar onNavigate para volver al inicio
